...
test("Convex approval reducer rejects wrong action, order, site, logistics, and sandbox binding", () => {
  const order = { _id: "order-a", siteId: "site-a", cjApprovalActionId: "action-a", cjOrderInputHash: "hash-a", cjOrderInput: { orderNumber: "dsa-sb-a", logisticName: "Quoted route", fromCountryCode: "US" }, cjLogisticsPreflight: { logisticName: "Quoted route" } };
  const action = { _id: "action-a", siteId: "site-a", type: "dispatch_cj_sandbox_order", status: "approved", params: { orderId: "order-a", orderNumber: "dsa-sb-a", inputHash: "hash-a", isSandbox: 1, payType: 3, logisticName: "Quoted route", fromCountryCode: "US" } };
